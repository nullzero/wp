...
templateSemiProtection = {
            ...
            'th':[ur'\{\{กึ่งล็อก(.*?)\}\}', ur'\{\{ล็อกชั่วคราว\}\}', ur'\{\{ล็อกพิเศษ\}\}', ur'\{\{[Pp]p-semi-protected\}\}', ur'\{\{ล็อกป้องกัน\}\}']
            }
...
templateTotalProtection = {
            ...
            'th':[ur'\{\{ล็อก(\|(.*?))?\}\}', ur'\{\{[Pp]rotected template\}\}', ur'\{\{[Pp]p-template\}\}', ur'\{\{[Hh]protected\}\}']
            }
# Regex to get the semi-protection move template
templateSemiMoveProtection = {
            'th':[ur'\{\{ล็อกย้าย(.*?)\}\}', ur'\{\{[Pp]p-move\}\}'],
            'en': None,
...
categoryToCheck = {
            ...
            'zh':[u'Category:被保护的页面',u'Category:被保護的模板',u'Category:暂时不能移动的页面',
                u'Category:被半保护的页面',],
            'th':[u'Category:บทความที่ถูกล็อก', u'Category:แม่แบบที่ถูกกึ่งล็อก', u'Category:แม่แบบที่ถูกล็อก', u'Category:บทความที่กึ่งล็อก', u'Category:หมวดหมู่:บทความที่ถูกป้องกันการเปลี่ยนทาง'],
            }
...
comment = {
            ...
            'zh':u'機器人: 移除過期的保護模板',
            'th':u'แก้ไขป้ายการล็อกให้ถูกต้อง',
            }
# Check list to block the users that haven't set their preferences
project_inserted = ['en', 'fr', 'it', 'ja', 'pt', 'zh', 'th']
