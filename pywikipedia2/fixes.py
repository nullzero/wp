...
fixes = {
    ...
    'nullzero': {
        ...
        'replacements' : [
            ...
            (u'เ?บราว?์?เซอร์',  u'เบราว์เซอร์'),
            ...
            (u'ฑูต', u'ทูต'),
            (u'ด็?อ[ทต]คอม', u'ดอตคอม'),
            (u'ด็?อ[ตท]เน็?[ตท]', u'ดอตเน็ต'),
            ...
            (u'บรรได', u'บันได'),
            (u'บล[็๊]อ[กค]', u'บล็อก'),
            #(u'เบรค', u'เบรก'),
            #(u'ไบท์', u'ไบต์'),
            (u'ปฎิ', u'ปฏิ'),
            (u'ป[ฏฎ]ิกริยา', u'ปฏิกิริยา'),
            (u'ปรากฎ', u'ปรากฏ'),
            (u'ปราถนา', u'ปรารถนา'),
            (u'[พป]ีร[าะ]มิด', u'พีระมิด'),
            (u'โปรเจ็?ค(ท์|ต์)?', u'โปรเจกต์'),
            ...
            (u'รถยนตร์', u'รถยนต์'),
            #(u'ล็อค', u'ล็อก'),
            (u'ลอส\ ?แอ[งน]เจ[อล]?ล[ีิ]ส', u'ลอสแอนเจลิส'),
            (u'ลายเซ็นต์', u'ลายเซ็น'),
            (u'ลิ[้๊]ง[กค]์', u'ลิงก์'),
            (u'เวคเตอร์', u'เวกเตอร์'),
            (u'เวท(ย์)?มน(ต์|ตร์)', u'เวทมนตร์'),
            (u'เว็?บไซ[ตท]์?', u'เว็บไซต์'),
            ...
            (u'สเตชั่น', u'สเตชัน'),
            (u'สมดุลย์', u'สมดุล'),
            (u'สวดมน(ต์|ตร์)?', u'สวดมนต์'),
            (u'สวรรณคต', u'สวรรคต'),
            (u'อโดบี', u'อะโดบี'),
            (u'อานิเมะ', u'อะนิเมะ'),
            (u'อลูมิเนียม', u'อะลูมิเนียม'),
            (u'ออ[บป]เจ็?ค', u'อ็อบเจกต์'),
            (u'อั[พป]เด็?[ตท]', u'อัปเดต'),
            (u'อัพโหลด', u'อัปโหลด'),
            (u'อิเล็กโทรนิกส์', u'อิเล็กทรอนิกส์'),
            (u'อิสระภาพ', u'อิสรภาพ'),
            (u'เอ็?นจิ้?น', u'เอนจิน'),
            (u'เอล์ฟ', u'เอลฟ์'),
            (u'เอาท์พุ[ตท]', u'เอาต์พุต'),
            (u'แอ[ปพ]พลิค?เคชั่?น', u'แอปพลิเคชัน'),
            (u'<references?\s+/>', u'{{รายการอ้างอิง}}'),
            (u'\{\{[Rr]eflist(?P<param>.*?)\}\}', u'{{รายการอ้างอิง\g<param>}}'),
        ],
    },
}
